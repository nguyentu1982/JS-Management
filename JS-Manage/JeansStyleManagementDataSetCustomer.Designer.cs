...
namespace JS_Manage {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("JeansStyleManagementDataSetCustomer")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class JeansStyleManagementDataSetCustomer : global::System.Data.DataSet {
        ...
        public JeansStyleManagementDataSetCustomer() {
            this.BeginInit();
            this.InitClass();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected JeansStyleManagementDataSetCustomer(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            JeansStyleManagementDataSetCustomer cln = ((JeansStyleManagementDataSetCustomer)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "JeansStyleManagementDataSetCustomer";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/JeansStyleManagementDataSetCustomer.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            JeansStyleManagementDataSetCustomer ds = new JeansStyleManagementDataSetCustomer();
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string CustomerName, string Address, string Telephone) {
...
namespace JS_Manage.JeansStyleManagementDataSetCustomerTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([CustomerId] = @Original_CustomerId) AND ([CustomerName] = @Original_CustomerName) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([CustomerName], [Address], [Telephone]) VALUES (@Cu" +
                "stomerName, @Address, @Telephone);\r\nSELECT CustomerId, CustomerName, Address, Te" +
                "lephone FROM Customer WHERE (CustomerId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [CustomerName] = @CustomerName, [Address] = @Address, [Telephone] = @Telephone WHERE (([CustomerId] = @Original_CustomerId) AND ([CustomerName] = @Original_CustomerName) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)));
SELECT CustomerId, CustomerName, Address, Telephone FROM Customer WHERE (CustomerId = @CustomerId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CustomerName, Address, Telephone FROM dbo.Customer";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Customer\r\nWHERE        (CustomerId = @custId)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@custId", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerId", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        CustomerId, CustomerName, Address, Telephone\r\nFROM            Custo" +
            ...
            this._commandCollection[3].CommandText = "SELECT CustomerId, CustomerName, Address, Telephone FROM dbo.Customer\r\nwhere Cust" +
                "omerName like @customerName";
            ...
            this._commandCollection[4].CommandText = "UPDATE       Customer\r\nSET                CustomerName = @CustomerName, Address =" +
                " @Address, Telephone = @Telephone\r\nWHERE        (CustomerId = @customerId); ";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerName", global::System.Data.SqlDbType.NVarChar, 255, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Address", global::System.Data.SqlDbType.NVarChar, 500, global::System.Data.ParameterDirection.Input, 0, 0, "Address", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable) {
        ...
        public virtual JeansStyleManagementDataSetCustomer.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable = new JeansStyleManagementDataSetCustomer.CustomerDataTable();
        ...
        public virtual int FillByCustomerId(JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable, int customerId) {
        ...
        public virtual JeansStyleManagementDataSetCustomer.CustomerDataTable GetDataByCustomerId(int customerId) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(customerId));
            JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable = new JeansStyleManagementDataSetCustomer.CustomerDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCustomerName(JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable, string customerName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual JeansStyleManagementDataSetCustomer.CustomerDataTable GetDataByCustomerName(string customerName) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((customerName == null)) {
                throw new global::System.ArgumentNullException("customerName");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(JeansStyleManagementDataSetCustomer.CustomerDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(JeansStyleManagementDataSetCustomer dataSet) {
        ...
        public virtual int Delete(int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Telephone) {
        ...
        public virtual int Insert(string CustomerName, string Address, string Telephone) {
            if ((CustomerName == null)) {
                throw new global::System.ArgumentNullException("CustomerName");
            }
            else {
        ...
        public virtual int Update(string CustomerName, string Address, string Telephone, int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Telephone, int CustomerId) {
            if ((CustomerName == null)) {
                throw new global::System.ArgumentNullException("CustomerName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerName, string Address, string Telephone, int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Telephone) {
            return this.Update(CustomerName, Address, Telephone, Original_CustomerId, Original_CustomerName, Original_Address, Original_Telephone, Original_CustomerId);
        }
        ...
        public virtual int DeleteCustomerById(int custId) {
        ...
        public virtual int UpdateCustomerById(string CustomerName, string Address, string Telephone, int customerId) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(JeansStyleManagementDataSetCustomer dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(JeansStyleManagementDataSetCustomer dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(JeansStyleManagementDataSetCustomer dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(JeansStyleManagementDataSetCustomer dataSet) {
            if ((dataSet == null)) {
